...
const basePath = '/core-tech-1775455950137';
...
export default function Home() {
  ...
  const products = [{ n: 'Hosting Solutions', d: 'Our reliable and secure hosting solutions ensure that your website or application is always accessible, with scalable plans to meet your growing needs. From shared hosting to dedicated servers, we\'ve got you covered.', i: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80', icon: 'domain' }, { n: 'Web Development', d: 'Our team of expert web developers crafts custom websites and applications that are visually stunning, user-friendly, and optimized for performance, helping you establish a strong online presence and drive business growth.', i: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=800&q=80', icon: 'architecture' }, { n: 'Application Development', d: 'We design and develop bespoke mobile and desktop applications that meet your specific business needs, from concept to launch, ensuring a seamless user experience and maximum ROI.', i: 'https://images.unsplash.com/photo-1504639725590-34d0984388bd?w=800&q=80', icon: 'chair' }, { n: 'Domain Registration', d: 'Secure your brand\'s online identity with our domain registration services, offering a wide range of extensions and reliable management tools to help you maintain your web presence.', i: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=400&q=80', icon: 'eco' }, { n: 'Inquiry Services', d: 'Our dedicated team is always available to answer your questions and provide personalized support, ensuring that you get the most out of our services and stay ahead of the competition.', i: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=400&q=80', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1518770660439-4636190af475?w=1200&q=80" alt="Hero" className="w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Core Tech, we specialize in providing top-notch technology solutions to businesses and individuals in Kuching, focusing on web development, application development, and hosting services. Our team of experts is dedicated to delivering innovative and customer-centric solutions that meet the unique needs of our clients. With a strong commitment to excellence and a passion for technology, we strive to be the go-to tech partner for businesses in the region.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To be the leading provider of technology solutions in Kuching, empowering businesses to succeed in the digital age.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To deliver innovative, customer-centric technology solutions that exceed our clients\' expectations and help them achieve their goals.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Customer first</h4>
                  <p className="text-sm text-on-surface-variant">We prioritize our customers\' needs, ensuring that our solutions are tailored to meet their unique requirements and provide exceptional value.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Innovation</h4>
                  <p className="text-sm text-on-surface-variant">We foster a culture of innovation, encouraging experimentation, learning, and continuous improvement to stay ahead of the curve in the ever-evolving tech landscape.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=1200&q=80" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.unsplash.com/photo-1504639725590-34d0984388bd?w=400&q=80" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=800&q=80" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
